...
With the new proxy feature switching storage providers is as easy as updating <i><mark style="background-color: lightgrey">storage.yml</markstyle></i> in your rails application. You can also now easily use wildcard subdomains and have more freedom in naming your buckets.
